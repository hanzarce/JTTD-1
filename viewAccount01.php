...
<head>
    ...
    <title>Account: <?php echo $id; ?></title>
 ...
 <!----------------------- END NOTIFICATIONS --------------------------------------------------------------->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Account: <?php echo $id; ?> </h4>
...
<br><br>
    ...
    <a href="viewAccounts.php"><button type="submit" class="btn btn-warning btn-fill pull-right">Back to Accounts</button></a>
